...
|---------------------|-----------------|---------------------------------------------------|
| Customer VM eth2    | 10.67.247.11    | Main interface — all routable traffic            |
| Customer VM eth1    | 100.64.122.15   | Storage only — L2, no routing                    |
...
| CGS-A (ex.Active)   | 10.67.247.253   | Processes all live traffic                       |
| CGS-B (ex.Standby)  | 10.67.247.252   | Hot spare — CGS-A failure takeover               |
| F5 VIP              | 10.67.247.249   | Floating internet LB IP                          |
| F5 SELF IP          | 10.67.247.250   | Self f5 LB IP                          |
| F5 SELF IP          | 10.67.247.251   | Self f5 LB IP                          |
| CGS INFRA iface     | 198.18.27.146   | CGS eth0 — bridge into VRF INFRA                 |
